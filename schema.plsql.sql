---------------------------------------------------------------------------------------------
--Tạo Schema QLDA với pass=1234                                                             
--create user QLDA identified by 1234;                                                      
--                                                                                          
--gán quyền dba cho QLDA
--grant dba to QLDA;
---------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------
...
create table CHITIEU (
       maChiTieu number(10,0) not null,
       tenChiTieu nvarchar2(30),
       soTien float,
       duAn number(10,0),
       constraint PK_CHITIEU primary key (maChiTieu)
);
alter table CHITIEU
modify tenChiTieu nvarchar2(80);
alter table CHITIEU
modify maCHITIEU char(9 char);
--Tạo bảng NHANVIEN
...
modify duAn number(10,0) not null;
--Tạo bảng PHONGBAN
create table PHONGBAN (
       maPhong char(9 char) not null,
